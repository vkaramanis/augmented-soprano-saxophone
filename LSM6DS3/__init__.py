...
from LSM6DS3_Registers.REGISTERS import Master, Acceleration, Gyroscope, Temperature
from LSM6DS3_Registers.PREFERENCES import AcceleratorFS, AcceleratorBW, AcceleratorODR, GyroscopeFS, GyroscopeODR
